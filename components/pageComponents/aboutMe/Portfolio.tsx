...
import { ChatBubbleLeftIcon as AnnotationIcon, GlobeAltIcon, BoltIcon, ScaleIcon, ArrowDownTrayIcon as DownloadIcon, AcademicCapIcon, BriefcaseIcon, StarIcon } from '@heroicons/react/24/outline'
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <div className="flex flex-row gap-6 justify-center lg:justify-start">
                                ...
                                <Button
                                    className="group relative px-8 py-4 text-lg font-semibold rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl"
                                    onClick={() => window.open('/assets/images/aboutme/_resume_v1.pdf', '_blank')}
                                    style={{
                                        background: theme === 'dark'
                        ...
                        <div className="flex justify-center lg:justify-end">
                            <div className="relative">
                                ...
                                <a
                                    ...
                                    className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r from-blue-800 to-red-800 rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer group"
                                    aria-label="Visit GitHub Profile"
                                >
                                    <svg
                                        className="w-10 h-10 text-white group-hover:text-blue-200 transition-colors duration-300"
                                        fill="currentColor"
                                        viewBox="0 0 24 24"
                                        aria-hidden="true"
                                    >
