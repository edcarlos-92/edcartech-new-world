    ...
    <footer className="bg-gray-900" aria-labelledby="footer-heading">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-3 lg:px-8">
        ...
        {/* <div className="border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          ...
          <form className="mt-4 sm:flex sm:max-w-md lg:mt-0">
            ...
            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full bg-indigo-800 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-0 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <a  href="#"   className="mt-8 text-base text-gray-400 md:mt-0 md:order-1" >
            Privacy & Policy
         </a>
