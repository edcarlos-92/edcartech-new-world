  ...
  return (
    <main>
        ...
        <article className="max-w-3xl mx-auto p-5 ">
            ...
            <h2 className="text-xl font-light text-gray-500">{post.description}
            </h2>
        ...
        {submitted ? (
            ...
            <label className="block mb-5">
                ...
                <input 
                    ...
                    className="shadow border rounded py-2 px form-input mt-t block w-full ring-yellow-500 focus:ring outline-none" placeholder='Carlos Edorh' 
                    type="text" 
                />
            </label>
            ...
            <label className="block mb-5">
                ...
                <input 
                    ...
                    className="shadow border rounded py-2 px form-input mt-t block w-full ring-yellow-500 focus:ring outline-none" placeholder='example@edcartech.com' 
                    type="text" 
                />
            </label>
